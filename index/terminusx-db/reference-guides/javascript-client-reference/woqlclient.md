...
| \[lastDataVersion] | `string`               | the last data version tracking id.                                             |
| \[getDataVersion]  | `boolean`              | If true the function will return object having result and dataVersion.         |
| \[query]           | `object`               | If a query object is provided, the function will use it to query the database. |
...
**woqlClient.getDiff(before, after, options) ⇒ `Promise`**
...
| options | `object` | \[{}] - Options to send to the diff endpoint |
...
**woqlClient.getVersionObjectDiff(id, beforeVersion, after, options) ⇒ `Promise`**
...
**woqlClient.getVersionDiff(id, beforeVersion, afterVersion, options) ⇒ `Promise`**
